...
(function configureEvergage() {
    try {
       Evergage.configure({
           ...
           siteConfigVersion: "362"
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"INR","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["IndivId","customerId","emailAddress","leadID","phoneNumber","profileId","sfmcContactKey","webIDRE","webIDREStore"],"lastModified":1713441353615,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":true,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
...
try {
    ...
    if (/store/.test(window.location.hostname)) {
        if (JSON.parse(localStorage.getItem("mage-cache-storage")).customer) {
            email__c = JSON.parse(localStorage.getItem("mage-cache-storage")).customer.email;
            phone__c = JSON.parse(localStorage.getItem("mage-cache-storage")).customer.mobile;
        }
    }
} catch (error) {
    //console.error(error);
...
let buybackModels = {
    "METEOR 350": "VUSD60SU",
    "SHOTGUN 650": "VAVS60HY",
    "SUPER METEOR 650": "VUMT60SH",
    "CLASSIC 350": "VBFV60DN",
    "BULLET 350": "VLCQ60HK",
    "INTERCEPTOR 650": "VDDJ60BY",
    "HUNTER 350": "VSKM60HT",
    "SCRAM 411": "VJQL60GE",
    "CONTINENTAL GT 650": "VLWJ60BS",
    "NEW HIMALAYAN": "VNJK60GC"
}
...
if (SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID") == 'VNJK60GC') { var bool = true } else { bool = false }
    ...
    const sitemapConfigRE = {
        global: {
            onActionEvent: (actionEvent) => {
                let currentViewedModel = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID")
                if (currentViewedModel) {
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.attributes = actionEvent.user.attributes || {};
                    actionEvent.user.attributes.currentModelViewed = currentViewedModel;
                }
        ...
        pageTypes: [
            {
                ...
                contentZones: [
                    {
                        name: "home_page_gallery_heading", selector: "#is_hero_banner"
                    },
                    {
                        name: 'slide_popup'
                    },
...

            {
                ...
                isMatch: () => SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pageType") == "View Finance Assured Buyback Page",
                interaction: {
                    name: "View Finance Assured Buyback Page"
                },
                listeners: [
                    SalesforceInteractions.listener("change", "#motorcycleContent", () => {
                        buybackModel = SalesforceInteractions.cashDom("#motorcycleContent").val()
            ...
            { // Check if reqruied
                ...
                /*Added by Customer Centria Start */
                contentZones: [
                    { name: "GMA_Listing" },
            ...
            },
            {
                ...
                isMatch: () => {
                    ...
                    const isMatchMotorcycles = (url[3] === 'motorcycles' && url[4] === 'goan-classic-350' && url[5] ==='campaign');
                    const pdp = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pageType") == "Campaign Page"
                    return isMatchMotorcycles || pdp;
                },
                onActionEvent: (actionEvent) => {
                    const model = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID")
                    const urlContainsGoanClassic350 = window.location.href.includes("goan-classic-350");
                    const finalModel = urlContainsGoanClassic350 ? "DH5000A" : model;
                    ...
                    if (SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID") == "VCGL60WD") {
                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                ...
                interaction: {
                    ...
                    catalogObject: {
                        ...
                        id: () => {
                            const winObj = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID")
                            console.log('winObj:', winObj);
                            const winID = "DH5000A"
                            const url = window.location.pathname.split('/');
                            const isMatchMotorcycles = (url[3] === 'motorcycles' && url[4] === 'goan-classic-350');
                            console.log('isMatchMotorcycles:', isMatchMotorcycles);
                            if (winObj) {
                                return winObj;
                        ...
                        relatedCatalogObjects: {
                            Category: () => {
                                const winObj = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pageCategory");
                                const url = window.location.pathname.split('/');
                                const isMatchMotorcyclesClassic = (url[3] === 'motorcycles' && url[4] === 'goan-classic-350');
                                const result = [];
                ...
                listeners: [
                    SalesforceInteractions.listener("click", '[capture-leads="true"]', () => {
                        // let modelOfInterest__ = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID")
                        const model = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID")
                        const urlContainsGoanClassic350 = window.location.href.includes("goan-classic-350");
                        const finalModel = urlContainsGoanClassic350 ? "DH5000A" : model;

                        console.log(modelOfInterest__)
                        ...
                        SalesforceInteractions.sendEvent({
                            ...
                            user: {
                                identities: {
                                    phoneNumber: SalesforceInteractions.cashDom('#phone').val(),
                                    emailAddress: SalesforceInteractions.cashDom('#email').val(),
                                },
                                attributes: {
                                    firstname__c: SalesforceInteractions.cashDom('#fullName').val(),
                                    customer_pincode__c: SalesforceInteractions.cashDom('#pincodeAutocomplete').val(),
                                    modelOfInterest: finalModel
            ...
            },
            {
                ...
                isMatch: () => SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pageType") == "Ride Calendar Page",
                interaction: {
                    name: "View Rides Calendar Page",
                },
                contentZones: [
...

            {
                ...
                isMatch: () => /finance/.test(window.location.href) && !(/assured-buyback/.test(window.location.href)),
                interaction: {
                    name: "View Finance Page",
                },
                contentZones: [
            ...
            },
            {
                ...
                isMatch: () => {
                    const url = window.location.pathname.split('/');
                    const isMatchMotorcycles = (url[3] === 'motorcycles' && url[4] === 'goan-classic-350' && url[5] ==='');
                    const pdp = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pageType") == "Motorcycle PDP"
                    return isMatchMotorcycles || pdp;
                },
                onActionEvent: (actionEvent) => {
                    const model = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID")
                    ...
                    let leadUC2Status = /review/.test(window.location.href) || /#teasers-section/.test(window.location.href)
                    ...
                    catalogObject: {
                        ...
                        relatedCatalogObjects: {
                            Category: () => {
                                ...
                                const url = window.location.pathname.split('/');
                                const isMatchMotorcyclesClassic = (url[3] === 'motorcycles' && url[4] === 'goan-classic-350');
                                const isMatchMotorcyclesBear = (url[3] === 'motorcycles' && url[4] === 'bear-650');
                                const result = [];
                                if (isMatchMotorcyclesBear) {
                                    result.push("Scrambler");
                                } else if (isMatchMotorcyclesClassic) {
                                    result.push("Bobber");
                                } else if (winObj) {
                                    result.push(winObj);
                                }
                ...
                contentZones: [
                    ...
                    {
                        name: "color_switch", selector: ".bike-thumbs-slider"
                    }
                ],
                listeners: [
                    ...
                    SalesforceInteractions.listener("click", "#submitForm", () => {
                        SalesforceInteractions.sendEvent({
                            ...
                            user: {
                                identities: {
                                    phoneNumber: SalesforceInteractions.cashDom('#mobile').val(),
                                    emailAddress: SalesforceInteractions.cashDom('#email').val(),
                                },
                                attributes: {
                                    customer_pincode__c: SalesforceInteractions.cashDom('#pincode').val(),
                                    firstname__c: SalesforceInteractions.cashDom('#fname').val(),
                                    modelOfInterest: SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.productID")

                                }
                            },
                        });
                    }),
                    SalesforceInteractions.listener("click", ".bookTestRideFormMain__rightSideBtr__formContainer__btrSubmitBtn", () => {
                            ...
                            SalesforceInteractions.sendEvent({
                                ...
                                user: {
                                    identities: {
                                        ...
                                        emailAddress: SalesforceInteractions.cashDom('#email-id').val(),
                                    },
                                    attributes: {
                                        customer_pincode__c: SalesforceInteractions.cashDom('#pin-code').val(),
                                        firstname__c: SalesforceInteractions.cashDom('#first-name').val(),
                                        modelOfInterest: "DH5000A"
                                    }
                                },
                            });
                        }
                    ...
                    SalesforceInteractions.DisplayUtils.pageScroll(0.7).then(function (event) {
                        if (SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pageType") == "Motorcycle PDP") {
                            SalesforceInteractions.sendEvent({
                                interaction: {
                    ...
                    SalesforceInteractions.listener("click", "[title='Detailed Review']", () => {
                        SalesforceInteractions.sendEvent({
                            interaction: {
                    ...
                    SalesforceInteractions.listener("click", '[title="Pre-book Now"],[title="Pre Book Now"]', () => {
                        console.log('click')
                        SalesforceInteractions.sendEvent({
                            interaction: {
                                name: "Pre-book Now",
                    ...
                    SalesforceInteractions.listener("click", '[title="Watch the film"]', () => {
                        console.log('click')
                        SalesforceInteractions.sendEvent({
                            interaction: {
                                name: "Watch the Film"
                    ...
                    SalesforceInteractions.listener('click', '.color-swatch', (e) => {
                        var color = SalesforceInteractions.cashDom(e.target).attr('data-name');
                        console.log(color)
                        SalesforceInteractions.sendEvent({
                            interaction: {
                    ...
                    SalesforceInteractions.listener('click', '.bike-color-swatch', (e) => {
                        if (e.target.tagName == 'IMG') {
                            var color_ = SalesforceInteractions.cashDom(e.target).attr('title');
                        }
                        if (e.target.tagName == 'P') {
                            color_ = SalesforceInteractions.cashDom(e.target)[0].innerText;
                        }
                        SalesforceInteractions.sendEvent({
                            interaction: {
                                name: SalesforceInteractions.CatalogObjectInteractionName.ViewCatalogObjectDetail,
                    ...
                    //classic350
                    SalesforceInteractions.listener('click', '.tank-slide', (e) => {
                        if (e.target.tagName == 'IMG') {
                            var color = SalesforceInteractions.cashDom(e.target).attr('title');
                            console.log(color);
                        }
                        if (e.target.tagName == 'P') {
                            var color_ = SalesforceInteractions.cashDom(e.target)[0].innerText;
                            console.log(color_)
                    ...
                    SalesforceInteractions.listener('click', '.inner-image', (e) => {
                        console.log(e.target.tagName)
                        if (e.target.tagName == 'IMG') {
                            var color = SalesforceInteractions.cashDom(e.target).attr('title')
                            console.log(color)
                    ...
                    //Himalayan K1G
                    SalesforceInteractions.listener('click', '.reLazyloaded', (e) => {
                        console.log(e.target.tagName)
                        if (e.target.tagName == 'IMG') {
                            var color = SalesforceInteractions.cashDom(e.target).attr('title')
                            console.log(color)
            ...
            },
            {
                ...
                listeners: [
                    SalesforceInteractions.listener("click", "#btrSubmitBtn", () => {
                        ...
                        console.log(recentModelVisited_)
            ...
            // New rental page code start
            {
                ...
                listeners: [
                    ...
                    //  SalesforceInteractions.listener("click", '[data-bannertype="Stay Updated"]', () => {
                    //     console.log(click)
                    //     // SalesforceInteractions.sendEvent({
                    //     //   interaction: {
                    //     //     name: "Click REGISTER INTEREST button",
                    //     //   },
                    //     // });
                    // }),
                    ...
                    SalesforceInteractions.listener("click", ".divForRedirectionBtn.submitPopUpBtn", () => {
                        console.log('click')
                        SalesforceInteractions.sendEvent({
                            interaction: {
                            ...
                            user: {
                                identities: {
                                    emailAddress: SalesforceInteractions.cashDom('#mailId').val(),
                                    phoneNumber: SalesforceInteractions.cashDom('#mobileNumber').val(),
                                },
                                attributes: {
                                    destinationtorent: SalesforceInteractions.cashDom('#destination').val(),
                                    name__c: SalesforceInteractions.cashDom('#firstName').val(),
                                    lastname__c: SalesforceInteractions.cashDom('#lastName').val(),
                                    //	enquiryNo : SalesforceInteractions.cashDom('.enquiry-digit.setEnquiryId')[0].innerText,
                                }
                            },
                        });
                    }),
            ...
            },
            {
                ...
                listeners: [
SalesforceInteractions.listener("click", ".meteor-btn > a", (event) => {
    if (event.target.title === "Get It on App Store" || event.target.title === "Get It on Play Store") {
        SalesforceInteractions.sendEvent({
            interaction: {
    ...
    const sitemapConfigMIY = {
        ...
        pageTypes: [
            {
                name: "View MIY Select City Page",
                isMatch: () => /select-city/.test(window.location.href),
                interaction: {
                    name: "View MIY Select City Page",
                },
                listeners: [
                    SalesforceInteractions.listener("click", ".stateCitySelector .link", () => {
                        SalesforceInteractions.sendEvent({
                            interaction: {
                                name: "MIY State - City Submit"
                            },
                            user: {
                                attributes: {
                                    district__c: Evergage.cashDom("#city-state-row .selected").text(),
                                    city__c: Evergage.cashDom("#city-state-row .selected").last().text(),
                                }
                            },
                        });
                    }),
            ...
            {
                name: "View MIY Models Page",
                isMatch: () => /models/.test(window.location.href),
                interaction: {
                    name: "View MIY Models Page",
                },
            ...
            {
                name: "View MIY Value Adds Page",
                isMatch: () => /value-adds/.test(window.location.href),
                interaction: {
                    name: "View MIY Value Adds Page",
                },
            },
            {
                name: "View MIY Locate Dealer Page",
                isMatch: () => /locate-dealer/.test(window.location.href),
                interaction: {
                    name: "View MIY Locate Dealer Page",
                },
            },
            {
                name: "View MIY Booking Information Page",
                isMatch: () => /booking-information/.test(window.location.href),
                interaction: {
                    name: "View MIY Booking Information Page",
                },
            },
            {
                name: "View MIY Booking Summary Page",
                isMatch: () => /booking-summary/.test(window.location.href),
                interaction: {
                    name: "View MIY Booking Summary Page",
                },
            },
            ...
            {
                name: "View MIY Saved Configurations Page",
                isMatch: () => /saved-configurations/.test(window.location.href),
                onActionEvent: (actionEvent) => {
                    const SavedConfiguratorURL = SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.SavedConfiguratorURL");
                    if (SavedConfiguratorURL) {
                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.SavedConfiguratorURL = SavedConfiguratorURL;
                    }
                    return actionEvent;
                },
                interaction: {
    ...
    const sitemapConfigStore = {
        global: {
            onActionEvent: (actionEvent) => {
                ...
                const customer_id = SalesforceInteractions.cashDom("[name=customer_id]").attr("value");
                ...
                if (lastVisitStore) {
                    ...
                    actionEvent.user.attributes.loggedStatus = email__c ? 'true' : 'false';
                }
                ...
                /*const customer_mobile = SalesforceInteractions.cashDom("[name=customer_mobile]").attr("value");
                if (customer_mobile && customer_mobile!= "null") {
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.identities = actionEvent.user.identities || {};
                    actionEvent.user.identities.phoneNumber = customer_mobile;
                }
                const customer_email = SalesforceInteractions.cashDom("[name=customer_email]").attr("value");
                if (customer_email && customer_email!= "null") {
                    actionEvent.user = actionEvent.user || {};
                    actionEvent.user.identities = actionEvent.user.identities || {};
                    actionEvent.user.identities.emailAddress = customer_email;
                }*/
                return actionEvent;
            },
            contentZones: [
            ...
            listeners: [
                ...
                SalesforceInteractions.listener("click", ".custom_remove_item", (e) => {
                    let lineItem = {
                        ...
                        catalogObjectId: SalesforceInteractions.cashDom(e.target).parents('.product-item-details').find('.pro').val(),
                        quantity: Number(SalesforceInteractions.cashDom(e.target).parents('.product-item-details').find('.cart-item-qty').attr('data-item-qty')),
                        price: parseFloat(SalesforceInteractions.cashDom(e.target).parents('.product-item-details').find('.price').text().replace(/[^0-9\.]+/g, "")),
                    }
                    SalesforceInteractions.sendEvent({
                        interaction: {
                ...
                SalesforceInteractions.listener("click", ".login-otp-btn", () => {
                    const identity__ = SalesforceInteractions.cashDom('#login-email-pop').val()
                ...
                SalesforceInteractions.listener("submit", "#customer-popup-login-form", () => {
                    const identity_ = SalesforceInteractions.cashDom('#login-email-pop').val();
                    if (identity_.search("@") != -1) {
                ...
                SalesforceInteractions.listener("click", "[data-mcp-productid]", (e) => {
                    SalesforceInteractions.sendEvent({
                        interaction: {
                            ...
                            catalogObject: {
                                type: "Product",
                                id: SalesforceInteractions.cashDom(e.target).attr("data-mcp-productid"),
                            },
                        },
                    });
                }),
        ...
        pageTypes: [
            {
                ...
                contentZones: [
                    {
                        name: "home_page_prod_rec", selector: ".myoimage"
                    },
                    {
            ...
            },
            {
                ...
                isMatch: () =>
                    new Promise((resolve, reject) => {
                        ...
                        return SalesforceInteractions.DisplayUtils.pageElementLoaded("body", "html").then(() => {
                            clearTimeout(isMatchHP);
                            resolve(SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pagetype") == 'Product Details Page');
                        });
                    }),
                onActionEvent: (actionEvent) => {
                    const lastBrowseImage_ = SalesforceInteractions.getSitemapResult().currentPage.interaction.catalogObject.attributes.imageUrl;
                    const lastBrowseProductName_ = SalesforceInteractions.resolvers.fromMeta("title")();
                    ...
                    if (lastBrowseImage_) {
                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.lastBrowseProductImage = lastBrowseImage_;
                    }
                    ...
                    catalogObject: {
                        ...
                        id: () => {
                            return SalesforceInteractions.util.resolveWhenTrue.bind(() => {
                                const productId = SalesforceInteractions.cashDom(".product-info-container .price-box.price-final_price").attr("data-product-id");
                                if (productId) {
                                    return productId;
                                } else {
                                    return false;
                        ...
                        attributes: {
                            ...
                            imageUrl: SalesforceInteractions.DisplayUtils.pageElementLoaded("[itemprop='image']").then(() => {
                                return SalesforceInteractions.resolvers.fromSelectorAttribute("[itemprop='image']", "src", (url) => url.split('?')[0])
                            }),
                            inventoryCount: 1,
                            price: SalesforceInteractions.DisplayUtils.pageElementLoaded('[data-price-type="finalPrice"]').then(() => {
                                return SalesforceInteractions.resolvers.fromSelectorAttribute('[data-price-type="finalPrice"]', 'data-price-amount', (v) => Number(v))
                            }),
                            currency: 'INR',
                        },
                ...
                listeners: [
                    SalesforceInteractions.listener("click", "#product-addtocart-button", () => {
                        let lineItem = {
                            catalogObjectType: 'Product',
                            catalogObjectId: SalesforceInteractions.cashDom(".product-info-container .price-box.price-final_price").attr("data-product-id"),
                            quantity: Number(SalesforceInteractions.cashDom("input.qty").val()),
                ...
                isMatch: () =>
                    new Promise((resolve, reject) => {
                        ...
                        return SalesforceInteractions.DisplayUtils.pageElementLoaded("body", "html").then(() => {
                            ...
                            resolve(SalesforceInteractions.cashDom(".customer-account-index").length > 0);
                        });
                    }),
                interaction: {
                    name: 'View Store Account Page'
                ...
                isMatch: () =>
                    new Promise((resolve, reject) => {
                        ...
                        return SalesforceInteractions.DisplayUtils.pageElementLoaded("body", "html").then(() => {
                            ...
                            resolve(SalesforceInteractions.cashDom(".catalog-category-view").length > 0);
                        });
                    }),
                interaction: {
                    name: SalesforceInteractions.CatalogObjectInteractionName.ViewCatalogObject,
...

            {
                ...
                isMatch: () =>
                    ///checkout/.test(window.location.href) && /cart/.test(window.location.href),
                    new Promise((resolve, reject) => {
                        ...
                        return SalesforceInteractions.DisplayUtils.pageElementLoaded("body", "html").then(() => {
                            ...
                            resolve(SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pagetype") == "Cart Detail Page");
                        });
                    }),
                interaction: {
                    name: SalesforceInteractions.CartInteractionName.ReplaceCart,
                    lineItems: () => {
                        if (SalesforceInteractions.cashDom(".cart.item.type-configurable").length > 0) {
                            return SalesforceInteractions.DisplayUtils.pageElementLoaded(
                                ...
                                let cartLineItems = [];
                                SalesforceInteractions.cashDom(".cart.item.type-configurable").each((index, ele) => {
                                    let itemQuantity = Number(SalesforceInteractions.cashDom(ele).find("input.qty").val());

                                    if (itemQuantity && itemQuantity > 0) {
                                        let lineItem = {
                                            catalogObjectType: "Product",
                                            catalogObjectId: SalesforceInteractions.cashDom(ele).find('input.pro').val(),
                                            price: Number(SalesforceInteractions.cashDom(ele).find('span.price').text().replace(/[^0-9\.]+/g, "")),
                ...
                listeners: [
                    ...
                    SalesforceInteractions.listener("click", ".action-delete", (e) => {
                        lineItem = {
                            catalogObjectType: 'Product',
                            catalogObjectId: SalesforceInteractions.cashDom(e.target).parents('tbody').find('input.pro').val(),
                            quantity: Number(SalesforceInteractions.cashDom(e.target).parents('tbody').find('[data-role="cart-item-qty"]').val()),
                            price: Number(SalesforceInteractions.cashDom(e.target).parents('tbody').find('span.price').text().replace(/[^0-9\.]+/g, "")),
                        }
                ...
                isMatch: () =>
                    ...
                    new Promise((resolve, reject) => {
                        ...
                        return SalesforceInteractions.DisplayUtils.pageElementLoaded("body", "html").then(() => {
                            ...
                            resolve(SalesforceInteractions.mcis.getValueFromNestedObject("window.mcp.pagetype") == "Checkout Page");
                        });
                    }),
                interaction: {
                    name: "View Store Checkout Page",
            ...
            },
            {
                ...
                listeners: [
                    SalesforceInteractions.listener("submit", "#form-validate", () => {
                        ...
                        let phone_ = '91'.concat(SalesforceInteractions.cashDom('#mobile_no').val());
                        let individ_ = 'AR-'.concat(SalesforceInteractions.cashDom('#mobile_no').val());
                        let gender_ = SalesforceInteractions.cashDom('#gender option:checked').text();
                        if (email_ && phone_) {
                            SalesforceInteractions.sendEvent({
                                interaction: {
